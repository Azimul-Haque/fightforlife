            ...
            <div class="map-contact col-md-6 col-sm-6 bg-light-orange" @desktop style="height: 460px !important;" @enddesktop>
                <ul>
                    ...
                    <li>
                        ...
                        অনুদান জমা হবে ঢাকা বিশ্ববিদ্যালয়ের তথ্য প্রযুক্তি ইন্সটিটিউট এর শিক্ষার্থীদের উদ্যোগ "ফাইট ফর লাইফ" প্রজেক্ট এর তহবিল এ। এই অর্থ পৌঁছে যাবে বিদ্যানন্দ  ও গিফট ফর গুডস স্বেচ্ছাসেবী সংগঠনগুলোর কাছে।
                    </li> 
                    <li>
